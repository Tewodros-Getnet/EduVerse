    ...
    return (
        <div className="space-y-6 max-w-2xl">
            ...
            <div className="bg-[var(--surface)] border border-[var(--border)] rounded-2xl p-6 space-y-5">
                <h2 className="text-base font-semibold text-white border-b border-[var(--border)] pb-3">General</h2>
                <div>
                    ...
                    <input value={settings.platform_name} onChange={e => setSettings(s => ({ ...s, platform_name: e.target.value }))}
                        className="w-full bg-[var(--surface-2)] border border-[var(--border)] rounded-xl px-4 py-2.5 text-white focus:outline-none focus:border-purple-500 text-sm" />
                </div>
            ...
            <div className="bg-[var(--surface)] border border-[var(--border)] rounded-2xl p-6 space-y-5">
                <h2 className="text-base font-semibold text-white border-b border-[var(--border)] pb-3">Security</h2>
                <div>
            ...
            <div className="bg-[var(--surface)] border border-[var(--border)] rounded-2xl p-6 space-y-5">
                <h2 className="text-base font-semibold text-white border-b border-[var(--border)] pb-3">AI Configuration</h2>
                <div>
