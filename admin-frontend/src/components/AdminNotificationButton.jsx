    ...
    return (
        <div className="relative" ref={dropdownRef}>
            ...
            >
                ...
                {/* Notification Badge */}
                {unreadCount > 0 && (
                    <span className="absolute -top-1 -right-1 min-w-[20px] h-5 bg-gradient-to-r from-red-500 to-orange-500 text-[var(--text)] text-xs font-bold rounded-full flex items-center justify-center px-1 shadow-lg animate-bounce">
                                ...
                                {filteredNotifications.map(notification => (
                                    <div
                                        ...
                                        className={`p-4 hover:bg-[var(--surface)] transition-colors cursor-pointer group ${
                                            !notification.is_read ? 'bg-[var(--accent-primary)]/10' : ''
                                        }`}
